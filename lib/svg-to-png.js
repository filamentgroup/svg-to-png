...
(function(exports) {
	...
	var convertNoMin = function( files, outputDir, opts ){
	...
	var convertMin = function( files, outputDir, opts ){
	...
	exports.convert = function( input, output, opts ){
		...
		if( opts.minify ){
			return convertMin( files, output, opts );
		} else {
			return convertNoMin( files, output, opts );
		}
